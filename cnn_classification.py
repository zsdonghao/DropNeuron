...
def main_classification():
    ...
    # print("")
    # print(params[0].get_value()[0,:,:,:]**2)
    # print((params[0].get_value()[0,:,:,:]**2).sum())
    # print("")
    # print((params[0].get_value()**2 ).sum(axis=2).sum(axis=2))
    # print((params[0].get_value()**2 ).sum(axis=2).sum(axis=2).shape)
    # exit()
